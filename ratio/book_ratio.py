...
DB_IDS = "./Book/DB_Book_ids"
YAGO_IDS = "./Book/YAGO_Book_ids"

# And the dicts of triple with ids are:
DB_TRIPLES = "./Book/DB_Book_triples" 
YAGO_TRIPLES = "./Book/YAGO_Book_triples"

# r_metric for actor
R_METRICS = "./Book/edo_book_index2.r.m"


SAMEAS_PAIR_FILE = "./Book/Book.Goldstandard.txt.oi"
...
if __name__ == "__main__":
    ...
    assert(all_pair == 1249329895)
 
    sameas_rme_pareto = pareto(14979,sameas_rme_ranked)
    ...
    initial_ratio = 0.32831325301204817
    e2 = ['created-inv', 'haspages']
    nb_sameas = 1744
