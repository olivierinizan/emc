...
DB_IDS = "./Film/DB_Film_ids"
YAGO_IDS = "./Film/YAGO_Film_ids"

# And the dicts of triple with ids are:
DB_TRIPLES = "./Film/DB_Film_triples" 
YAGO_TRIPLES = "./Film/YAGO_Film_triples"

# r_metric for actor
R_METRICS = "./Film/edo_film_index2.r.m"


SAMEAS_PAIR_FILE = "./Film/Film.Goldstandard.N-1.txt"
...
if __name__ == "__main__":
    ...
    assert(all_pair == 10176725416)
 
    sameas_rme_pareto = pareto(66402,sameas_rme_ranked)
    ...
    initial_ratio =  1.090550232738262e-06
    nb_sameas = 0 
    e0 = []
    e0_r_metrics = compute_r_metrics_for_one_epsilon(r_metrics,e0)
    sameas_e0_r_metrics = compute_r_metrics_for_one_epsilon(sameas_r_metrics,e0)
    compute_sameas_ratio(sameas_e0_r_metrics,e1_r_metrics,initial_ratio,nb_sameas,e0)

    initial_ratio =  0.03727182015613077
    nb_sameas = 1905 
    e1 = ['wascreatedondate', 'wascreatedonyear']
    ...
    initial_ratio = 0.36793422404933196
    nb_sameas = 1432  
    e2 = ['actedin-inv', 'created-inv', 'directed-inv', 'wrotemusicfor-inv']
    ...
    initial_ratio = 0.0923147581139008
    nb_sameas = 1206
    e3 = ['actedin-inv', 'created-inv', 'directed-inv']
    ...
    initial_ratio = 0.16086175942549372
    nb_sameas = 896
    e4 = ['actedin-inv', 'directed-inv', 'wrotemusicfor-inv']
    ...
    initial_ratio = 0.5661157024793388
    nb_sameas = 822
    e5  = ['actedin-inv', 'created-inv', 'directed-inv', 'edited-inv', 'wrotemusicfor-inv']
    ...
    initial_ratio = 0.015126754661638382
    e6 = ['actedin-inv', 'directed-inv']  
    nb_sameas = 722 
    ...
    compute_sameas_ratio(sameas_e6_r_metrics,e6_r_metrics,initial_ratio,nb_sameas,e6)

    initial_ratio = 0.49780701754385964
    nb_sameas = 681
    e7 = ['actedin-inv', 'directed-inv', 'edited-inv', 'wrotemusicfor-inv']
    ...
    compute_sameas_ratio(sameas_e7_r_metrics,e7_r_metrics,initial_ratio,nb_sameas,e7)


    initial_ratio = 2.94851994456086e-05
    nb_sameas = 508
    e8 = ['wascreatedonyear']
    e8_r_metrics = compute_r_metrics_for_one_epsilon(r_metrics,e8)
    sameas_e8_r_metrics = compute_r_metrics_for_one_epsilon(sameas_r_metrics,e8)
    compute_sameas_ratio(sameas_e8_r_metrics,e8_r_metrics,initial_ratio,nb_sameas,e8)
